...
class MelbourneCafeManager {
    ...
    func setupCafes() {
        ...
        let AuntHours: [[( Date,Date)]] = [
            [(createDate(hour: 7, minute:0 ), createDate(hour: 17, minute: 0))], // Monday
            [(createDate(hour: 7, minute: 0), createDate(hour: 17, minute: 0))], // Tuesday
            [(createDate(hour: 7, minute: 30), createDate(hour: 19, minute: 0))], // Wednesday
            [(createDate(hour: 7, minute: 0), createDate(hour: 19, minute: 0))], // Thursday
            [(createDate(hour: 7, minute: 0), createDate(hour: 19, minute: 0))], // Friday
            [(createDate(hour: 8, minute: 0), createDate(hour: 19, minute: 0))], // Saturday
            [(createDate(hour: 8, minute: 0), createDate(hour: 17, minute: 0))], // Sunday
        ]
        ...
        guard let higherImage = UIImage(named: "higher1"),
              ...
              let soulCafeImage = UIImage(named: "soulcafe1"),
              let soulCafeImage2 = UIImage(named: "soulcafe2"),
              let soulCafeImage3 = UIImage(named: "soulcafe3"),
              let soulCafeImage4 = UIImage(named: "soulcafe4"),
        ...
        cafes = [
            ...
            Cafe(id: "2", name: "Aix Cafe", address: "24 Centre Pl, Melbourne VIC 3000, Australia", rating: 4, coordinate: LocationCoordinate(latitude: -37.816699, longitude:144.9656491), openingHours:AixHours.flatMap {$0}, description: "Tiny creperie with warm vibe, offering sweet choices like nutella and mango, or savoury peking duck.", images: [aixcafeImage, aixcafeImage2, aixcafeImage3,aixcafeImage4]),
            ...
            Cafe(id: "4", name: "The Journal Cafe", address: "253 Flinders Ln, Melbourne VIC 3000, Australia", rating: 4, coordinate: LocationCoordinate(latitude: -37.817840576171875, longitude: 144.9658660888672), openingHours: JournalHours.flatMap {$0}, description: "Light meals in a spacious, high-ceilinged cafe with suspended bookshelves and retro furniture.", images:[journalImage,journalImage2, journalImage3, journalImage4]),
            ...
            Cafe(id: "6", name: "Coffee Roasters", address: "St Ali Coffee Roasters, 12-18 Yarra Place, South Melbourne VIC 3205, Australia", rating: 4, coordinate: LocationCoordinate(latitude: -37.8313313, longitude: 144.9604687), openingHours: ALiHours.flatMap {$0}, description: "Warm, low-lit cafe in converted warehouse with exposed brick and furniture made from old lift doors.", images: [coffeeroastersImage,coffeeroastersImage2,coffeeroastersImage3,coffeeroastersImage4]),
            Cafe(id: "7", name: "Soul Cafe", address: "184 Surrey Rd, Blackburn VIC 3130, Australia", rating: 4, coordinate: LocationCoordinate(latitude:-37.813182, longitude: 144.965246), openingHours: AuntHours.flatMap {$0}, description: "Breakfast, sandwhichs & burgers offered in a long, modernroom with counter seating.", images:[soulCafeImage,soulCafeImage2,soulCafeImage3,soulCafeImage4]),
        ]
