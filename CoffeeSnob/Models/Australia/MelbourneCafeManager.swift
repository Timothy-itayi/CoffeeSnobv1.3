...
class MelbourneCafeManager {
    ...
    func setupCafes() {
        ...
        cafes = [
            Cafe(id: "0", name: "Higher Ground", address: " 650 Little Bourke St, Melbourne VIC 3000, Australia", rating: 4.1, coordinate: LocationCoordinate(latitude: -37.8144645690918, longitude: 144.9585418701172), openingHours: HigherHours.flatMap {$0}, description: "Modern, upscale bites in an industrial-chic former power station with exposed-brick walls.", images:[higherImage, higherImage2,higherImage3,higherImage4]),
            Cafe(id: "1", name: "Cafe Kinetic", address: "103 Flinders Ln, Melbourne VIC 3000, Australia", rating: 4.5, coordinate: LocationCoordinate(latitude: -37.81537628173828, longitude: 144.97068786621094),openingHours: KineticHours.flatMap {$0}, description: "Smart, casual cafe for a buffet of roasts, vegetables and salad, with chandeliers and ample seating", images:[kineticImage,kineticImage2,kineticImage3,kineticImage4]),
            Cafe(id: "2", name: "Aix Cafe", address: "24 Centre Pl, Melbourne VIC 3000, Australia", rating: 4.7, coordinate: LocationCoordinate(latitude: -37.816699, longitude:144.9656491), openingHours:AixHours.flatMap {$0}, description: "Tiny creperie with warm vibe, offering sweet choices like nutella and mango, or savoury peking duck.", images: [aixcafeImage, aixcafeImage2, aixcafeImage3,aixcafeImage4]),
            Cafe(id: "3", name: "Brick Lane Melbourne", address: " 33 Guildford Ln, Melbourne VIC 3000, Australia", rating: 4.1, coordinate: LocationCoordinate(latitude: -37.8114349, longitude: 144.9598528), openingHours: BrickLaneHours.flatMap {$0}, description: "Menu", images:[bricklaneImage, bricklaneImage2, bricklaneImage3, bricklaneImage4]),
            Cafe(id: "4", name: "The Journal Cafe", address: "253 Flinders Ln, Melbourne VIC 3000, Australia", rating: 4.1, coordinate: LocationCoordinate(latitude: -37.817840576171875, longitude: 144.9658660888672), openingHours: JournalHours.flatMap {$0}, description: "Light meals in a spacious, high-ceilinged cafe with suspended bookshelves and retro furniture.", images:[journalImage,journalImage2, journalImage3, journalImage4]),
            Cafe(id: "5", name: "The Kettle Black", address: "50 Albert Rd, South Melbourne VIC 3205, Australia", rating: 4.0, coordinate: LocationCoordinate(latitude: -37.83432388305664, longitude: 144.9714813232422), openingHours: KettleHours.flatMap {$0}, description: "Modern Australian cafe fare served in a chic terrace house with white walls & modern lighting.", images: [kettleblackImage, kettleblackImage2, kettleblackImage3, kettleblackImage4]),
            Cafe(id: "6", name: "Coffee Roasters", address: "St Ali Coffee Roasters, 12-18 Yarra Place, South Melbourne VIC 3205, Australia", rating: 4.0, coordinate: LocationCoordinate(latitude: -37.8313313, longitude: 144.9604687), openingHours: ALiHours.flatMap {$0}, description: "Warm, low-lit cafe in converted warehouse with exposed brick and furniture made from old lift doors.", images: [coffeeroastersImage,coffeeroastersImage2,coffeeroastersImage3,coffeeroastersImage4]),
            Cafe(id: "7", name: "Aunt Billies Cafe", address: "184 Surrey Rd, Blackburn VIC 3130, Australia", rating: 4.4, coordinate: LocationCoordinate(latitude:-37.8162727355957, longitude: 145.15655517578125), openingHours: AuntHours.flatMap {$0}, description: "Warm, low-lit cafe in converted warehouse with exposed brick and furniture made from old lift doors.", images:[auntbilliesImage,auntbilliesImage2,auntbilliesImage3,auntbilliesImage4]),
        ]
